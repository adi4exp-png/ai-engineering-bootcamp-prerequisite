...
import instructor
import numpy as np
from qdrant_client.models import FieldCondition, Filter, MatchValue, Prefetch, FusionQuery, Document

class RAGUsedContext(BaseModel):
    id:str = Field(description="The ID of the items used to answer the question")
